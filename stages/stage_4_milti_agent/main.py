...
async def check_routing(state: LegalState) -> dict:
    """Routing node: determine which specialist sub-agents are needed via keyword matching."""
    print("\n  [Node: check_routing] Determining which specialists are needed by keyword matching...")
...
QUESTION = "A tech company is sharing user data and has complex overseas tax obligations. What are the legal consequences?"
